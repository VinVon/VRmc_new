...
import com.medvision.vrmc.update.NetworkUtil;
import com.medvision.vrmc.update.UpdateVersionService;
...
//			VersionInfo mVersionInfo = JsonUtil.jsonToBean(array.getJSONObject(0).toString(), VersionInfo.class);
    ...
    public static void showDialog(final Context context,final VersionInfo versionInfo){
        ...
        if(file.exists() && file.getName().equals("vrmc_"+versionInfo.getData().getVersionName()+".apk")){
