package com.medvision.vrmc.adapter.patientDetil;
...
public class MyItemDecoration extends BaseDecoration {
    ...
    public MyItemDecoration(GroupListener groupListener,Context context) {
        super();
...
//根据前一个组名，判断当前是否为新的组
    ...
    public static class Builder {
        ...
        private Builder(GroupListener groupListener,Context context) {
            mDecoration = new MyItemDecoration(groupListener,context);
        }

        public static Builder init(GroupListener groupListener,Context context) {
            return new Builder(groupListener,context);
        }
        ...
        public Builder setGroupTextSize(int textSize) {
            mDecoration.mTextSize =  mDecoration.dip2px(textSize);
        ...
        public Builder setGroupHeight(int groutHeight) {
            mDecoration.mGroupHeight = mDecoration.dip2px(groutHeight);
            return this;
        }
        ...
        public Builder setTextSideMargin(int leftMargin) {
            mDecoration.mSideMargin = mDecoration.dip2px(leftMargin);
            return this;
        }
