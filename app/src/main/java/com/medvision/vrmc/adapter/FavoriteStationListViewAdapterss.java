...
public class FavoriteStationListViewAdapterss extends BaseSwipeAdapter {
    ...
    public FavoriteStationListViewAdapterss(Context mContext, ArrayList<HomeContent> dataList, SetClick setClick) {
    ...
    public View generateView(int position, ViewGroup parent) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_therapysss, null);
        return v;
    }
